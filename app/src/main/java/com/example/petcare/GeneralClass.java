...
public static List<Doctor> getDoctors() {
    ...
    doctors.add(new Doctor("Dr. Ayesha Farooq", "DVM", "Companion Animal Clinic, Gulistan-e-Johar", "+92 331-5678901",R.drawable.doc_fem_3,"Specialized in rabbits,Take a good care of them"));
